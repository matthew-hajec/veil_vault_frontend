      ...
      <main className="pt-4 px-4 md:px-8 lg:px-12 max-w-3xl mx-auto">
        <section className="text-center mb-6">
          ...
          <p className="text-gray-600 text-sm">
            Decrypt and download your files securely. Your data privacy is our
            top priority.
          </p>
        </section>
        ...
        <Card>
          ...
          <p className="text-gray-600 text-sm mb-4">
            To access your file, please enter the password used during
            encryption. Without the correct password, the file cannot be
            decrypted.
          </p>
          <ul className="list-disc list-inside text-gray-600 text-sm space-y-2">
            ...
            <li>
              Click <strong>"Download and Decrypt"</strong> to securely retrieve
              your file.
            </li>
            <li>
              After decryption, click <strong>"Download"</strong> to save the
              file to your device.
            </li>
            <li>
              We do not store your password or decrypted files on our servers,
